...
for url in rss_urls:
	...
	filing_page = abs_ee_links[0] #this particular script is just pulling the most recent filing; but it can be changed to loop through all links, or as many as desired
...
charged_off_df.to_csv('Charge Off List.csv')